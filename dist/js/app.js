...
})({"8OJEu":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b506116c6fbaa6dc";
"use strict";
...
class App {
    ...
    onLoad() {
        if (this.activePage.onLoad) document.addEventListener("DOMContentLoaded", this.activePage.onLoad.bind());
    }
}
new App();
    ...
    onLoad() {
        setTimeout(()=>{
            ...
            if (model) {
                ...
                for (const option of selectElement.options)if (option.value === decodeModel) {
...
},{"swiper":"iM6UL","swiper/modules":"9ktz6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","swiper/swiper.min.css":"eFTGe"}],"iM6UL":[function(require,module,exports,__globalThis) {
/**
 * Swiper 11.1.14
...
},{"../shared/create-shadow.mjs":"bWkQq","../shared/effect-init.mjs":"88TTi","../shared/effect-target.mjs":"3jkAD","../shared/effect-virtual-transition-end.mjs":"dzFvU","../shared/utils.mjs":"9mU7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eFTGe":[function() {},{}]},["8OJEu","f6Hfm"], "f6Hfm", "parcelRequire94c2")
