...
function wpdocs_theme_name_scripts() {
    $customcsspath = filemtime(plugin_dir_url( __FILE__ ) . 'dist/css/custom.css');

    wp_enqueue_style( 'motorskin-script-style', plugin_dir_url( __FILE__ ).'dist/js/app.css' );
	wp_enqueue_style( 'motorskin-custom-style', plugin_dir_url( __FILE__ ).'dist/css/custom.css', array(),$customcsspath );
